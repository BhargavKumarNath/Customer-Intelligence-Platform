...
# Note: Cohort analysis requires preprocessing not available in sample mode
st.info("""
📊 **Cohort retention analysis** requires pre-computed weekly retention tables.

In **full dataset mode**, this would show:
- Week-over-week retention rates
- Cohort performance comparisons  
- Churn pattern identification

*This feature is available when running with the complete processed dataset.*
""")
